...
Generative AI was used to help structure the report, draft explanatory text, and organize the computational pipeline. All reported numerical results were produced by running the accompanying analysis script on the provided dataset, and the final interpretation was checked against those outputs.
